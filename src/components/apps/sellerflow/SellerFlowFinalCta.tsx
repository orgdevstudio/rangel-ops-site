...
import { StoreButtonsModal } from "@/components/apps/StoreButtonsModal";
import { sellerflowLanding } from "@/config/sellerflow-landing";

type SellerFlowFinalCtaProps = {
  googlePlayUrl: string;
  appStoreUrl?: string;
};

export function SellerFlowFinalCta({
  googlePlayUrl,
  appStoreUrl,
}: SellerFlowFinalCtaProps) {
  const { finalCta } = sellerflowLanding;
