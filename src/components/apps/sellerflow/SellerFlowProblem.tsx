...
export function SellerFlowProblem() {
  const { problem } = sellerflowLanding;
    ...
    <Section variant="default" background="default">
      <SectionReveal>
        <Container size="xl">
          ...
          <div
            className="relative mx-auto mt-12 max-w-3xl overflow-hidden rounded-2xl border border-[#0EA5E9]/35 bg-[#0EA5E9]/10 p-8 sm:p-10 text-center transition-all duration-300 ease-out motion-safe:hover:-translate-y-px"
