...
export function SellerFlowInstagram() {
  const { instagram } = sellerflowLanding;

  return (
    <Section variant="tight" background="muted" aria-label="Comunidade SellerFlow no Instagram">
      <SectionReveal>
        <Container size="md">
