...
export function Footer() {
  const socialLinks = [
    { key: "linkedin" as const, href: siteConfig.social.linkedin },
    { key: "twitter" as const, href: siteConfig.social.twitter },
    { key: "github" as const, href: siteConfig.social.github },
    { key: "instagram" as const, href: siteConfig.social.instagram },
  ];
        ...
        <div className="pb-16 lg:pb-20">
          <div className="grid gap-10 sm:grid-cols-2 sm:gap-8 lg:grid-cols-12 lg:gap-10">
            ...
            <div className="sm:col-span-2 lg:col-span-5">
              <Logo href="/" imageClassName="h-12 w-auto" />
              ...
              <div className="mt-6 flex gap-3">
                {socialLinks.map(({ key, href }) => (
                  <a
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-lg text-[#94a3b8]/80 transition-all duration-200 ease-out hover:bg-white/5 hover:text-[#0EA5E9]"
                    aria-label={key}
                  >
                    {socialIcons[key]}
                  </a>
